                ...
                function doImport(file) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            ...
                            const fileData = yield fs.promises.readFile(file);
                            core.info(`Read file successfully`);
                            // execute import
                            const result = yield xray.import(fileData, mimeType);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.doFormDataRequest = exports.resolveJson = exports.retrieveRepositoryPath = void 0;
const core = __importStar(__nccwpck_require__(2186));
...
module.exports = __nccwpck_require__(8596)
...
const goodies_1 = __nccwpck_require__(9186);
